...
class AppCoordinator: Coordinator {
    ...
    override func start() {
        ...
        tabBarController.tabBar.items?.first?.selectedImage = UIImage(named: "inicioUnselected")
        tabBarController.tabBar.items?.first?.image = UIImage(named: "inicio")
        
        tabBarController.tabBar.items?[1].image = UIImage(named: "mensajes")
        tabBarController.tabBar.items?[1].selectedImage = UIImage(named: "mensajesUnselected")
        
        tabBarController.tabBar.items?[2].image = UIImage(named: "usuarios")
        tabBarController.tabBar.items?[2].selectedImage = UIImage(named: "usuariosUnselected")
